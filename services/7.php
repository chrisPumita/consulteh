                    ...
                    <div class="service-details__sidebar">
                        <div class="service-details__sidebar-service">
                            <ul class="service-details__sidebar-service-list list-unstyled">
                                ...
                                <li><a href="./service.php?service=c81e728d9d4c2f636f067f89cc14862c">Asesoría en Juicios por Despido <span class="icon-right-arrow"></span></a></li>
                                ...
                                <li class="current"><a href="./service.php?service=8f14e45fceea167a5a36dedd4bea2543">Reglamento Interno del Trabajador <span class="icon-right-arrow"></span></a></li>
                            </ul>
                        </div>
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="service-details__right">
                        ...
                        <div class="service-details__content">
                            <h3 class="service-details__title">Reglamento Interno del Trabajador</h3>
...
$titulo = '<h2>Reglamento Interno del Trabajador</h2>
            <ul class="thm-breadcrumb list-unstyled">
                <li><a href="./">Inicio</a></li>
                <li><a href="services.php">Servicios</a></li>
                <li class="active">Reglamento Interno del Trabajador</li>
            </ul>';