                    ...
                    <div class="service-details__sidebar">
                        <div class="service-details__sidebar-service">
                            <ul class="service-details__sidebar-service-list list-unstyled">
                                <li class="current"><a href="./service.php?service=c4ca4238a0b923820dcc509a6f75849b">Asesoría Jurídica Sindical <span class="icon-right-arrow"></span></a></li>
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="service-details__right">
                        ...
                        <div class="service-details__content">
                            <h3 class="service-details__title">Asesoría Jurídica Sindical</h3>
...
$titulo = '<h2>Asesoría Jurídica Sindical</h2>
            <ul class="thm-breadcrumb list-unstyled">
                <li><a href="./">Inicio</a></li>
                <li><a href="services.php">Servicios</a></li>
                <li class="active">Asesoría Jurídica Sindical</li>
            </ul>';