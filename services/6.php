                    ...
                    <div class="service-details__sidebar">
                        <div class="service-details__sidebar-service">
                            <ul class="service-details__sidebar-service-list list-unstyled">
                                ...
                                <li class="current"><a href="./service.php?service=1679091c5a880faf6fb5e6087eb1b2dc">Recuperación de cuentas Afore <span class="icon-right-arrow"></span></a></li>
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="service-details__right">
                        ...
                        <div class="service-details__content">
                            <h3 class="service-details__title">Recuperación de cuentas Afore </h3>
...
$titulo = '<h2>Recuperación de cuentas Afore </h2>
            <ul class="thm-breadcrumb list-unstyled">
                <li><a href="./">Inicio</a></li>
                <li><a href="services.php">Servicios</a></li>
                <li class="active">Recuperación de cuentas Afore </li>
            </ul>';