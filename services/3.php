                    ...
                    <div class="service-details__sidebar">
                        <div class="service-details__sidebar-service">
                            <ul class="service-details__sidebar-service-list list-unstyled">
                                ...
                                <li class="current"><a href="./service.php?service=eccbc87e4b5ce2fe28308fd9f2a7baf3">Declaración de Beneficiarios <span class="icon-right-arrow"></span></a></li>
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="service-details__right">
                        ...
                        <div class="service-details__content">
                            <h3 class="service-details__title">Declaración de Beneficiarios</h3>
...
$titulo = '<h2>Declaración de Beneficiarios</h2>
            <ul class="thm-breadcrumb list-unstyled">
                <li><a href="./">Inicio</a></li>
                <li><a href="services.php">Servicios</a></li>
                <li class="active">Declaración de Beneficiarios</li>
            </ul>';